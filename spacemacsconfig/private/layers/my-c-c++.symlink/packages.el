...
(unless (version< emacs-version "24.4")
  (add-to-list 'my-c-c++-packages 'srefactor))

(defun my-c-c++/init-cc-mode ()
  (use-package cc-mode
    :defer t
    :init
    (add-to-list 'auto-mode-alist `("\\.h$" . ,my-c-c++-default-mode-for-headers))
    :config
    (progn
      (require 'compile)
...
(defun my-c-c++/init-clang-format ()
  (use-package clang-format
    :if my-c-c++-enable-clang-support))
...
(defun my-c-c++/post-init-company ()
    ...
    (when my-c-c++-enable-clang-support
      ...
      (spacemacs/add-to-hooks 'company-mode/more-than-prefix-guesser '(c-mode-hook c++-mode-hook))
